...
CONTENT_SLIDES = [
    ...
    (
        ...
        [
            ...
            (1, "git clone https://github.com/mmoster/tool.sap_cluster_checks.git"),
            (1, "cd tool.sap_cluster_checks"),
            (1, "./cluster_health_check.py --local"),
            (0, "Option 2: Download without git"),
            (1, "curl -L https://github.com/mmoster/tool.sap_cluster_checks/archive/refs/heads/main.tar.gz | tar xz"),
            (1, "cd tool.sap_cluster_checks-main"),
            (0, "Prerequisites:"),
    ...
    (
        ...
        [
            ...
            (1, "github.com/mmoster/tool.sap_cluster_checks"),
            (0, "Extend the Tool:"),
            ...
            (0, "Get started now:"),
            (1, "git clone https://github.com/mmoster/tool.sap_cluster_checks.git"),
            (1, "cd tool.sap_cluster_checks && ./cluster_health_check.py --local"),
        ],
    ),
]
