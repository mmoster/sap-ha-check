...
class TestExistsOperator:
    def test_value_present_passes(self):
        passed, msg, _ = _evaluate({"key": "value"}, {"key": "key", "operator": "exists"})
        assert passed is True

    def test_value_none_fails(self):
        passed, msg, _ = _evaluate({"key": None}, {"key": "key", "operator": "exists"})
        assert passed is False

    def test_key_missing_fails(self):
        passed, msg, _ = _evaluate({}, {"key": "key", "operator": "exists"})
        assert passed is False

    def test_expected_false_inverts_value_present(self):
        passed, msg, _ = _evaluate(
    ...
    def test_empty_string_counts_as_exists(self):
        passed, msg, _ = _evaluate({"key": ""}, {"key": "key", "operator": "exists"})
        assert passed is True

    def test_zero_counts_as_exists(self):
        passed, msg, _ = _evaluate({"key": 0}, {"key": "key", "operator": "exists"})
        assert passed is True


class TestNotExistsOperator:
    def test_value_none_passes(self):
        passed, msg, _ = _evaluate({"key": None}, {"key": "key", "operator": "not_exists"})
        assert passed is True

    def test_key_missing_passes(self):
        passed, msg, _ = _evaluate({}, {"key": "key", "operator": "not_exists"})
        assert passed is True

    def test_value_present_fails(self):
        passed, msg, _ = _evaluate({"key": "value"}, {"key": "key", "operator": "not_exists"})
        assert passed is False
...
class TestEqOperator:
    ...
    def test_int_equality(self):
        passed, msg, _ = _evaluate({"key": 42}, {"key": "key", "operator": "eq", "value": 42})
        assert passed is True
...
class TestGtLtOperators:
    def test_gt_passes(self):
        passed, msg, _ = _evaluate({"key": "10"}, {"key": "key", "operator": "gt", "value": "5"})
        assert passed is True

    def test_gt_fails(self):
        passed, msg, _ = _evaluate({"key": "3"}, {"key": "key", "operator": "gt", "value": "5"})
        assert passed is False

    def test_lt_passes(self):
        passed, msg, _ = _evaluate({"key": "3"}, {"key": "key", "operator": "lt", "value": "5"})
        assert passed is True

    def test_lt_fails(self):
        passed, msg, _ = _evaluate({"key": "10"}, {"key": "key", "operator": "lt", "value": "5"})
        assert passed is False
...
class TestCustomMessage:
    ...
    def test_default_fail_message(self):
        _, msg, _ = _evaluate({"key": None}, {"key": "mykey", "operator": "exists"})
        assert "mykey" in msg
